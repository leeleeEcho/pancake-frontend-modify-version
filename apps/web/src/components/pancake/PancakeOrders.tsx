...
import { Components, hooks, OrdersPortal, AllOrders, Order, Styles, OrderLoader } from '@orbs-network/twap-ui'
import {
...
const Provider = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <context.Provider
      value={{ showOpenOrders, setShowOpenOrders, hideCancelledOrders, setHideCancelledOrders, orders, ordersLoading }}
    >
      {children}
    </context.Provider>
  )
