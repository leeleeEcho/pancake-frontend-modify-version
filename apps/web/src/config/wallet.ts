  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/dapp/ztdx.io/',
      qrCode,
      downloadLink: 'https://metamask.app.link/dapp/ztdx.io/',
    },
    {
      id: 'trust',
      title: 'Trust Wallet',
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://ztdx.io/',
    ...
    },
    {
      ...
      deepLink:
        'https://www.okx.com/download?deeplink=okx%3A%2F%2Fwallet%2Fdapp%2Furl%3FdappUrl%3Dhttps%253A%252F%252Fztdx.io',
      guide: {
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://docs.ztdx.io/v/${docLangCodeMapping[code]}/get-started/wallet-guide`
    : `https://docs.ztdx.io/get-started/wallet-guide`
